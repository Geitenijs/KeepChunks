    ...
    public boolean onCommand(final CommandSender s, final Command c, final String label, final String[] args) {
        ...
        if (s instanceof Player) {
            try {
                ...
                final int maxPointX = sel.getMaximumPoint().x();
                final int maxPointZ = sel.getMaximumPoint().z();
                final int minPointX = sel.getMinimumPoint().x();
                final int minPointZ = sel.getMinimumPoint().z();
