...
public class CommandWrapper implements CommandExecutor, TabCompleter {
    ...
    private final CommandExecutor ChunkinfoCommand;
    private final CommandExecutor KeepchunkCommand;
    private final CommandExecutor KeepregionCommand;
    private final CommandExecutor KeeprailCommand;
    private final CommandExecutor ReleaseallCommand;
    private final CommandExecutor ReleasechunkCommand;
    private final CommandExecutor ReleaseregionCommand;
    private final CommandExecutor ReleaserailCommand;
    ...
    private final TabCompleter ChunkinfoTab;
    private final TabCompleter KeepchunkTab;
    private final TabCompleter KeepregionTab;
    private final TabCompleter KeeprailTab;
    private final TabCompleter ReleaseallTab;
    private final TabCompleter ReleasechunkTab;
    private final TabCompleter ReleaseregionTab;
    private final TabCompleter ReleaserailTab;
