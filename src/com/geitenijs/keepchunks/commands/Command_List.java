...
public class Command_List implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(final CommandSender s, final Command c, final String label, final String[] args) {
		if (args.length == 1) {
			if(Utilities.railchunks.isEmpty()) {
				Utilities.msg(s, "&cThere are currently no marked rail chunks.");
			}else {
				Utilities.msg(s, "&aA list of all marked rail chunks will be shown below.");
				Utilities.msg(s, "&7---");
