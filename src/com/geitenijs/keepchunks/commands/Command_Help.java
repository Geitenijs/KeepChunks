...
public class Command_Help implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(final CommandSender s, final Command c, final String label, final String[] args) {
        if (args.length == 1) {
            ...
            Utilities.msg(s, "&8/&akc list  &7-&f  List all marked chunks and rail chunks");
            Utilities.msg(s, "&8/&akc chunkinfo  &7-&f  Info about chunks");
            Utilities.msg(s, "&8/&akc keepchunk  &7-&f  Keep a single chunk loaded");
            Utilities.msg(s, "&8/&akc keeprail  &7-&f  Keep a minecart network loaded");
            ...
            Utilities.msg(s, "&8/&akc releaseallrails  &7-&f  Release all marked rail chunks");
            Utilities.msg(s, "&8/&akc releasechunk  &7-&f  Release a single chunk");
            Utilities.msg(s, "&8/&akc releaserail  &7-&f  Release a minecart network and its chunks");
