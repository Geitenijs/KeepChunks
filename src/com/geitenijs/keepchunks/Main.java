...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        Main.plugin = this;
        if ((version.contains("v1_14_R1") || version.contains("v1_13_R2") || version.contains("v1_13_R1") || version.contains("v1_12_R1") || version.contains("v1_11_R1") || version.contains("v1_10_R1")
            ...
            Utilities.consoleMsgPrefixed("§cYour server version is not compatible with this release of " + Strings.PLUGIN
                    + ". Supported versions are: 1.14, 1.13, 1.12, 1.11, 1.10, 1.9 and 1.8. You can download a different release at: "
                    + Strings.WEBSITE);
